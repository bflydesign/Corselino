...
<html>
	...
	$(document).ready(function() {
        ...
        <title>Corselino - Lingerie Veurne - Badmode</title>
    </head>
    <body id="badmode">        
        <!-- container -->
        <div id="container">
                ...
                <div id="wrapper">
                    ...
                    <div id="content">
                        <div id="textfield">
                            ...
                            <br />
                            <p>
                                <?php /*echo Brands::getPageContent('badmode'); */?>
                            </p>
                            <br />
...
/*                                //path to directory to scan. i have included a wildcard for a subdirectory
                    ...
                    <div id="footer">
                        <ul>
                            ...
                            <li class="item"><a href="mailto:info@corselino.be">info@corselino.be</a></li>
                            <li class="last"><a href="//www.pepas.be" target="_blank">Design by Pepas</a></li>
                        </ul>
                    </div>            
                </div>
            </div>
