...
(function (wind, $, undef) {
    ...
    /**
     * Remove the hover, focus, active models.
     *
     * @param jQuery $el Element with models
     ...
     * @param String className Class or models to add/remove
        ...
        uniformHandlers = [  // Objects that take care of "unification"
            ...
            },
            {
                ...
                apply: function ($el, options) {
                    ...
                    // Add focus models, toggling, active, etc.
                    bindUi($el, $div, options);
                    bindMany($el, options, {
                        "click touchend": function () {
            ...
            },
            {
                ...
                apply: function ($el, options) {
                    ...
                    // Add models for focus, handle active, checked
                    bindUi($el, $div, options);
                    bindMany($el, options, {
                        "click touchend": function () {
